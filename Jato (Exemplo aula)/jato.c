...
#define TEXTURA_DO_PLANO "image_thumb[1].png"
#define TEXTURA_DO_AVIAO "b55f3cb8557adaa.png"
...
void compoe_jato(void){
  ...
  gluCylinder(quadric, 0.5, 0.5, 2, 15, 5);
  glPopMatrix();
   quadric = gluNewQuadric();
  gluQuadricTexture(quadric, GL_TRUE);
  glPushMatrix();
  ...
  quadric = gluNewQuadric();
  gluQuadricTexture(quadric, GL_TRUE);
  gluCylinder(quadric, 0.7, 0.7, 4, 12, 3);
  ...
  glPushMatrix();
  glTranslatef(0,0,4);
  gluCylinder(quadric, 0.7, 0.0, 3, 15, 5);
  glPopMatrix();
